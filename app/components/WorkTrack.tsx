...
function TrackCard({ project }: { project: Project }) {
  ...
  return (
    ...
    >
      {/*
        The card opens the running site itself rather than a write-up about it.
        A client system behind a login has nothing to open, so it renders as a
        plain container — a dead link would be worse than no link.
      */}
